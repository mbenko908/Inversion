...
;
     restore,'/mnt/RAIDofsH/mbenko/data1/inversion/silicon/data_processing/phys_param_gris_si_10828_big_map_1_jun_20.save'
...
; Manuelle Korrekturen: 
   msk=0*msk
;
;;vym      for i=307,363 do for j=109,288 do if (azi1(i,j) gt 300) then $
;;   vym     msk(i,j)=1b 
...
;  for i=0,45 do for j=45,120 do if azi1(i,j) gt 150. then msk(i,j)=1b 
...
;stop
   save,filename='/mnt/RAIDofsH/mbenko/data1/inversion/silicon/data_processing/phys_param_gris_si_10828_big_map_1_jun_20_correct.save',sirres,sirerr,cint,stokes, extrc
stop
   return
