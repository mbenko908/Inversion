...
;   
   theta=53.921;3.9;65.921                                     ; edituj podla daneho dna  !!!!!! PRE KAZDY DEN INE
   beta=3;-8.89;3;-8.89;-8.7093678                                     ; edituj podla daneho dna  !!!!!! PRE KAZDY DEN INE
   mx1 =3 & mx2 = 426 &  my1 = 3  &  my2 = 180  ;364,161 aky chces mat finalny vyrez !!!! cenrovan vyrez na streds skvrnu;30;1612;42;662;14;806;21;331
...
;
  ; stop
    ...
    a -= 360*(a gt 360)
    azr = a
    inc =acos(bzr/(bbr>10.))/!dtor
    bxr = bbr*cos(azr*!dtor)*sin(inc*!dtor)
    byr = bbr * sin(azr*!dtor)*sin(inc*!dtor)
 
 ;stop   
; all values are with respect to the surface normal;physres[*,*,0]=cir ; int
physres[*,*,0]= cir
...
;stop
   save,filename='results2.save',physres
   stop
   return
   end
